...
export const AVAILABLE_SECTIONS: SectionDefinition[] = [
  {
    ...
    estimatedWords: 200,
    required: true,
    prompt: 'Write a concise executive summary covering the key product overview, business objectives, and expected outcomes.'
  },
  {
    id: 'market-analysis',
    ...
    estimatedWords: 300,
    required: false,
    prompt: 'Analyze the target market, competitive landscape, and market opportunity for this product.'
  },
  {
    ...
    estimatedWords: 500,
    required: true,
    prompt: 'Define detailed feature requirements including user stories, acceptance criteria, and technical specifications.'
  },
  {
    ...
    estimatedWords: 400,
    required: false,
    prompt: 'Outline the technical architecture, system design patterns, and implementation approach.'
  },
  {
    id: 'success-metrics',
    ...
    estimatedWords: 200,
    required: true,
    prompt: 'Define key success metrics, measurement methodologies, and success criteria for the product.'
  },
  {
    ...
    estimatedWords: 250,
    required: false,
    prompt: 'Create a project timeline with key milestones, phases, and deliverable schedules.'
  },
  {
    id: 'risk-mitigation',
    ...
    estimatedWords: 300,
    required: false,
    prompt: 'Identify potential risks, challenges, and corresponding mitigation strategies.'
  },
  {
    ...
    estimatedWords: 250,
    required: false,
    prompt: 'Analyze the impact on various stakeholders and outline change management considerations.'
  }
];
