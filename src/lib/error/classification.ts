...
export const ERROR_CLASSIFICATIONS: Record<ErrorCode, ErrorClassification> = {
  MISSING_API_KEY: {
    ...
    message: "Google Generative AI API key is missing. Please configure your API key to continue.",
    recoverable: false,
  ...
  NETWORK_TIMEOUT: {
    ...
    message: "Request timed out. This usually resolves itself, please try again.",
    recoverable: true,
  ...
  RATE_LIMITED: {
    ...
    severity: "info",
    title: "Rate Limited",
    message: "Too many requests sent recently. Please wait a moment before retrying.",
    recoverable: true,
  ...
  VALIDATION_FAILED: {
    ...
    message: "Generated content doesn't meet validation requirements and needs correction.",
    recoverable: true,
