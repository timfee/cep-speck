...
registerItem({
  ...
  toPrompt: (params: unknown, pack) => bannedText.toPrompt(params as bannedText.Params, pack!),
  validate: (draft, params, pack) => bannedText.validate(draft, params as bannedText.Params, pack!),
...
registerItem({
  ...
  validate: (draft, params) => competitorResearch.validate(draft, params as competitorResearch.Params),
  heal: (issues, params) => competitorResearch.heal(issues, params as competitorResearch.Params),
});

registerItem({
  itemId: crossSectionConsistency.itemId,
  toPrompt: () => crossSectionConsistency.toPrompt(),
  validate: (draft, params) => crossSectionConsistency.validate(draft, params as crossSectionConsistency.Params),
...
registerItem({
  ...
  validate: (draft, params) => executiveQuality.validate(draft, params as executiveQuality.Params),
...
registerItem({
  ...
  validate: (draft, params) => labelPattern.validate(draft, params as labelPattern.Params),
...
registerItem({
  ...
  validate: (draft, params) => metricsRequired.validate(draft, params as metricsRequired.Params),
  heal: (issues, params) => metricsRequired.heal(issues, params as metricsRequired.Params),
});

registerItem({
  itemId: personaCoverage.itemId,
  toPrompt: () => personaCoverage.toPrompt(),
  validate: (draft, params) => personaCoverage.validate(draft, params as personaCoverage.Params),
...
registerItem({
  ...
  validate: (draft, params) => sectionCount.validate(draft, params as sectionCount.Params),
  heal: (issues, params) => sectionCount.heal(issues, params as sectionCount.Params),
});

registerItem({
  itemId: skuDifferentiation.itemId,
  toPrompt: () => skuDifferentiation.toPrompt(),
  validate: (draft, params) => skuDifferentiation.validate(draft, params as skuDifferentiation.Params),
...
registerItem({
  ...
  validate: (draft, params) => wordBudget.validate(draft, params as wordBudget.Params),
  heal: (issues, params) => wordBudget.heal(issues, params as wordBudget.Params),
});
