...
export const PATTERNS = {
  // Header patterns
  NUMBERED_HEADER: /^#\s+\d+\./,
  HEADER_WITH_PATTERN: (pattern: string) => new RegExp(`^#\\s+\\d+\\.\\s+${pattern}`, 'gm'),
  ...
  SOURCE_OF_TRUTH: /\b(SoT|Source of Truth|CBCM|Reporting Connector|Admin Console)\b/,
  
  // Content quality patterns
  VAGUE_QUANTIFIERS: /\b(some|many|several|few|most|often|rarely|occasionally)\b/gi,
  HEDGING_LANGUAGE: /\b(might|could|should|would|possibly|perhaps|maybe|likely)\b/gi,
  OVER_EXPLANATION: [
